    ...
    <main class="py-10 container mx-auto flex flex-col items-center justify-center h-[calc(100dvh-49px)]">
      <div class="flex flex-col gap-4 -mt-[200px]">
        <div class="flex flex-col items-start space-y-3 sm:flex-row sm:space-y-0 sm:items-center sm:space-x-3">
          <p class="font-semibold text-red-500/50 text-9xl">302</p>
          <div class="flex flex-col gap-2">
            <h1 class="flex items-center space-x-2">
              ...
              <span class="text-xl font-medium text-neutral-600 sm:text-2xl ">
                Hey, you are not allowed to access this page.
              </span>
            </h1>
            <p class="text-base font-normal text-neutral-600">This page was not designed for you.</p>
