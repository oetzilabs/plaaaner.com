...
export const AlertDialogOverlay: ParentComponent<AlertDialogPrimitive.AlertDialogOverlayProps> = (props) => {
...
export const AlertDialogContent: ParentComponent<AlertDialogPrimitive.AlertDialogContentProps> = (props) => {
  const [local, rest] = splitProps(props, ["class"]);
...
export const AlertDialogTitle: ParentComponent<AlertDialogPrimitive.AlertDialogTitleProps> = (props) => {
  const [local, rest] = splitProps(props, ["class", "classList"]);
  return <AlertDialogPrimitive.Title class={cn("text-lg font-semibold", local.class)} {...rest} />;
};

export const AlertDialogDescription: ParentComponent<AlertDialogPrimitive.AlertDialogDescriptionProps> = (props) => {
  const [local, rest] = splitProps(props, ["class"]);
  return <AlertDialogPrimitive.Description class={cn("text-sm text-muted-foreground", local.class)} {...rest} />;
};

export const AlertDialogClose: ParentComponent<AlertDialogPrimitive.AlertDialogCloseButtonProps> = (props) => {
  const [local, rest] = splitProps(props, ["class"]);
  return (
...
export const AlertDialogAction: ParentComponent<AlertDialogPrimitive.AlertDialogCloseButtonProps> = (props) => {
  const [local, rest] = splitProps(props, ["class", "classList"]);
